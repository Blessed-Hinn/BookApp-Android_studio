         ...
         fun deleteBook(
            ...
            storageReference.delete()
                .addOnSuccessListener {
                    ...
                    ref.child(bookId)
                        ...
                        .addOnFailureListener { e ->
                            Log.d(
                                TAG,
                                "deleteBook: deleteBook: Failed to delete from db due to ${e.message}"
                            )
                            Toast.makeText(
                                context,
                                "Failed to db due to ${e.message}",
                                Toast.LENGTH_SHORT
                            ).show()
                        }
                ...
                .addOnFailureListener { e ->
                    Log.d(
                        TAG,
                        "deleteBook: deleteBook: Failed to delete from storage due to ${e.message}"
                    )
                    Toast.makeText(
                        context,
